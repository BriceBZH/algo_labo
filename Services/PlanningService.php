...
class PlanningService
{
    ...
    public function __construct(MetricsCalculator $metricsCalculator, TechnicianService $technicianService, EquipmentService $equipmentService, SampleService $sampleService, SchedulerService $schedulerService, ControlInputs $controlInputs) {
    ...
    public function generatePlanning(array $jsonDecoded) : array {
        $techniciansJson = $jsonDecoded['technicians'] ?? [];
        $equipmentsJson = $jsonDecoded['equipment'] ?? [];
        $samplesJson = $jsonDecoded['samples'] ?? [];
        
        try {
            $this->controlInputs->controlInputsJson($techniciansJson, $equipmentsJson, $samplesJson);
